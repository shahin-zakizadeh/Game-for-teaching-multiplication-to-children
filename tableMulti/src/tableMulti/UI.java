...
public class UI extends JFrame {
	...
	public UI() {
		...
		JLabel label = new JLabel("جدول ضرب برای کودکان باهوش");
		label.setBounds(135, -1, 149, 28);
		...
		layeredPane_2.setBackground(Color.RED);
		layeredPane_2.setBounds(10, 26, 403, 210);
